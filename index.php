...
<!DOCTYPE html><html><head><meta http-equiv="X-UA-Compatible" content="IE=EDGE"/></script><script>var SC_benchmarkPreloadEvents={headStart:new Date().getTime()};</script><meta http-equiv="Content-type" content="text/html; charset=utf-8"/><meta http-equiv="Content-Script-Type" content="text/javascript"/><meta name="apple-mobile-web-app-capable" content="yes"/><meta name="apple-mobile-web-app-status-bar-style" content="default"/><meta name="viewport" content="initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"/><link rel="apple-touch-icon" href="images/sproutcore-logo.png"/><title> &nbsp; </title><script>BUILD_INFO={buildMode:"production",buildNumber:"14H40",buildLocale:"es-es",currentUrl:"es-es/index.html",useRelativeUrls:false,styles:{x2:["stylesheet@2x-packed.css"],normal:["images/stylesheet-packed.css"]},images:{x2:["images/packed-1@2x.png"],normal:["images/packed-1.png"]}};</script><script type="text/javascript">String.preferredLanguage="es-es";</script><script type="text/javascript">if(!window.BUILD_INFO){BUILD_INFO={useRelativeUrls:false,currentUrl:window.location.pathname}
...
}})();</script><script type="text/javascript">(function(){if(self===top){document.documentElement.style.display="block"}else{if(self.location.origin!==top.location.origin){top.location=self.location;
return}}if(SC.browser.isMobileSafari===true||SC.browser.isAndroid===true||SC.browser.isSilk===true){window.location.replace("/unsupported_browser/")
}}());</script><script>SC.benchmarkPreloadEvents.headEnd=new Date().getTime();</script></head><body class="sc-theme sc-focus"><script>SC.benchmarkPreloadEvents.bodyStart=new Date().getTime();</script><script type="text/javascript">if(SC.setupBodyClassNames){SC.setupBodyClassNames()};</script><script type="text/javascript" src="images/javascript-packed.js"></script><script>SC.benchmarkPreloadEvents.bodyEnd=new Date().getTime();</script></body></html>
